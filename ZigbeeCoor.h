...
#define EMBER_AF_PLUGIN_CONCENTRATOR_MAX_TIME_BETWEEN_BROADCASTS_SECONDS 100
#define EMBER_AF_PLUGIN_CONCENTRATOR_ROUTE_ERROR_THRESHOLD 1
...
#define EMBER_AF_PLUGIN_NETWORK_FIND_RADIO_TX_POWER 17
